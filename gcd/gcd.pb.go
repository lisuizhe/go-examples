...
func (*GCDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_gcd_e74dcbe36aa3db1e, []int{0}
}
...
func (*GCDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_gcd_e74dcbe36aa3db1e, []int{1}
}
...
func init() { proto.RegisterFile("gcd.proto", fileDescriptor_gcd_e74dcbe36aa3db1e) }

var fileDescriptor_gcd_e74dcbe36aa3db1e = []byte{
